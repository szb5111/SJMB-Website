...
const STRANDS = [
  ...
  { col: 0, y0:  1.55, dA: 0.55, dW: 0.021, dP: 0.0, z: -1.10, k: [3.10, 5.23, 8.47], a: [0.62, 0.27, 0.11], w: [ 0.083, -0.061,  0.114], p: [0.0, 2.1, 4.4], gain: 1.00, thick: 0.085, variant: 0.00, rA: 0.16, rK: 23.7, rW:  0.087, rP: 1.7 },
  { col: 1, y0:  0.85, dA: 0.62, dW: 0.016, dP: 2.1, z:  0.60, k: [2.60, 4.41, 7.83], a: [0.70, 0.24, 0.10], w: [-0.072,  0.097, -0.053], p: [1.3, 5.0, 0.7], gain: 0.95, thick: 0.095, variant: 0.15, rA: 0.18, rK: 21.1, rW: -0.064, rP: 4.2 },
  ...
  { col: 1, y0: -0.60, dA: 0.58, dW: 0.019, dP: 1.2, z: -0.35, k: [2.90, 5.77, 8.99], a: [0.66, 0.22, 0.12], w: [-0.094,  0.058,  0.076], p: [5.6, 3.3, 1.1], gain: 1.00, thick: 0.090, variant: 0.00, rA: 0.17, rK: 25.9, rW: -0.078, rP: 3.1 },
  { col: 0, y0: -1.35, dA: 0.52, dW: 0.023, dP: 5.3, z:  0.25, k: [3.40, 4.87, 7.41], a: [0.58, 0.26, 0.10], w: [ 0.077, -0.105,  0.049], p: [2.4, 0.5, 5.9], gain: 0.92, thick: 0.080, variant: 0.25, rA: 0,    rK: 0,    rW: 0,      rP: 0   },
  { col: 1, y0: -2.05, dA: 0.60, dW: 0.014, dP: 3.6, z: -0.85, k: [2.30, 5.03, 9.67], a: [0.72, 0.20, 0.09], w: [-0.062,  0.084, -0.112], p: [4.7, 2.9, 3.5], gain: 0.78, thick: 0.105, variant: 0.60, rA: 0,    rK: 0,    rW: 0,      rP: 0   },
  { col: 1, y0:  2.30, dA: 0.50, dW: 0.018, dP: 0.8, z:  0.95, k: [2.10, 6.53, 8.11], a: [0.55, 0.18, 0.08], w: [ 0.069, -0.051,  0.089], p: [0.9, 4.2, 1.9], gain: 0.70, thick: 0.115, variant: 0.35, rA: 0,    rK: 0,    rW: 0,      rP: 0   }
];
